                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    ...
                                    <input hidden id="preferencia" value="<?php echo $preferencia->id;?>">
                                    <div id="mp-button" class="mp-button"></div>
                                    <button type="submit" id="otro-button" formmethod="post">Pagar</button>
                                </div>
                            </div>
                        </div>
                    </div>
